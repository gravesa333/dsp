...
*The probability of a male identical twin is 0.5**(1/300) = 1/600.  Fraternal twins can be a male pair, male/female, female/male, or female pair.  The probability of a fraternal twin brother is 0.25**(1/125) = 1/500.*

*Given these probabilities, the probability that Elvis' twin brother was identical is:*

*(1/600)/((1/500)+(1/600)) = **0.4545** or **5/11***
